...
export default function CTAButton({ ctaText }: ctaButtonProps): React.ReactElement {
  let link = "contact";
  if (ctaText === "Hablemos" || ctaText === "Obten ayuda" || ctaText === "Contactanos") {
    link = "/contacto";
  }
  return (
                    <Link href={link} className="text-2xl p-2 m-2 rounded-md bg-gradient-to-r from-green-500 to-blue-500 text-[#ffffff] shadow-lg transform active:scale-95 
