...
import {homeServiceCardsArr} from '@/app/lib/homeServiceCardsData';
import ServiceCard from "@/app/components/home-sections/ServiceCard";

// Custom grouping: 3, then 2, then 3
const firstGroup = homeServiceCardsArr.slice(0, 3);
const secondGroup = homeServiceCardsArr.slice(3, 5);
const thirdGroup = homeServiceCardsArr.slice(5, 8);


export default function Services(){
  return (
    <div id="services" className="flex flex-col justify-center items-center mt-5 md:mt-[5%] text-[#333333]">
      <h2 className="inter-text text-center font-bold text-3xl">Website Packages Tailored for Small Businesses:</h2>
      ...
      <div className="hidden md:block">
        ...
        <h2 className="text-center font-semibold text-3xl mt-6 ">Ongoing Services:</h2>
        ...
        <h2 className="text-center font-semibold text-3xl mt-6">Add-On Subscriptions:</h2>
