...
\> An inspired interpretation of Webflow's design language — a visual web development platform whose surface contrasts a deep navy \`#0A0A23\` primary against a generous white canvas, supported by steel blue \`#23508e\`, gold \`#dab63e\`, forest green \`#006400\`, and charcoal gray \`#333333\` for body text, and anchored by the proprietary WF Visual Sans family used at restrained 500 / 600 weights with negative tracking.
...
\|---|---|---|---|
\| primary / deep navy | \`#0A0A23\` | \`--color-primary\` | Primary brand color for headings, dark backgrounds, and buttons |
\| on primary | \`#ffffff\` | \`--color-on-primary\` | High-contrast text/icons on dark or saturated brand surfaces |
\| ink | \`#0A0A23\` | \`--color-ink\` | Heading and high-emphasis text color |
\| ink strong | \`#0A0A23\` | \`--color-ink-strong\` | Strong text treatment aligned to the primary navy |
\| body / charcoal gray | \`#333333\` | \`--color-body\` | Default body text color |
\| body mid | \`#333333\` | \`--color-body-mid\` | Secondary body text color |
\| mute | \`#666666\` | \`--color-mute\` | Muted supporting text neutral |
\| mute soft | \`#999999\` | \`--color-mute-soft\` | Soft supporting text neutral |
\| hairline | \`#d8d8d8\` | \`--color-hairline\` | Light divider/border neutral |
\| canvas | \`#ffffff\` | \`--color-canvas\` | Main page and card surface |
\| steel blue | \`#23508e\` | \`--color-steel-blue\` | Secondary accent for gradients, borders, and supporting emphasis |
\| gold | \`#dab63e\` | \`--color-gold\` | Highlight and CTA accent for badges, prices, and hover states |
\| forest green | \`#006400\` | \`--color-forest-green\` | Secondary accent for icons, links, and CTA backgrounds |
...
**### category card steel blue**
**\*\*Role:\*\*** category card steel blue component
...
**### category card navy**
**\*\*Role:\*\*** category card navy component
...
**### category card gold**
**\*\*Role:\*\*** category card gold component
...
**\*\*Role:\*\*** category card forest green component
...
**### category card gold alternate**
**\*\*Role:\*\*** category card gold alternate component
...
\- Do not introduce brand colors outside the documented navy / steel blue / gold / forest green / charcoal palette; reserve white and light neutrals for functional surfaces, contrast, and borders.
